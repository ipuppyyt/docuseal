<template>
  ...
  >
    <FieldSubmitter
      ...
      :menu-classes="'dropdown-content bg-base-100 menu menu-xs p-2 shadow rounded-box w-52 rounded-t-none -left-[1px] mt-[1px]'"
    ...
    <FieldType
      ...
      :button-classes="'px-1'"
      :menu-classes="'bg-base-100 rounded-t-none'"
    ...
    >
      ...
      >
        ...
        <ul
          ...
          tabindex="0"
          class="dropdown-content bg-base-100 menu menu-xs px-2 pb-2 pt-1 shadow rounded-box w-52 z-10 rounded-t-none"
