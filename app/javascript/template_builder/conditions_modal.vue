        ...
        <form @submit.prevent="validateSaveAndClose">
          <div class="my-4">
            ...
            >
              ...
              <select
                class="select select-bordered select-sm w-full bg-base-100 h-11 pl-4 text-base font-normal"
              ...
              <select
                ...
                :class="{ 'bg-base-100': condition.field_uuid, 'bg-base-300': !condition.field_uuid }"
              ...
              <input
                ...
                type="number"
                step="any"
                class="input input-bordered input-sm w-full bg-base-100 h-11 pl-4 text-base font-normal"
                :class="{ 'text-gray-300': !condition.value }"
